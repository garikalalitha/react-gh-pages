...
import profileIcon1 from './profile.png';
...
let App=()=>{
  ...
  let a=["sindhu","devi","madhu","anusha"]
  return(
    ...
    {profiles.map((value,index)=>(
         ...
         <div className="card" style={{boxShadow:"0px 8px 8px -8px #000"}}>
             <div className="card-body text-center">
               ...
               */}
               {value.basics.gender==="male"? <img src={profileIcon} alt="Profile icon" style={{width:"30%"}}/> :<img src={profileIcon1} alt="Profile icon1" style={{width:"30%"}}/>}
               <h3>{value.basics.name}</h3>
               <h5 className="text-secondary" style={{fontstyle:"italic"}}> 
               {value.basics.role}</h5> <hr/>
